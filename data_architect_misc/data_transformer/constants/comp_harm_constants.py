...
SPANISH_MEDIA_TYPE_MAPPINGS = {
    ...
    "(?i)Revista.*": "Print", "(?i)PRENSA.*": "Print", "(?i)DIARIO.*": "Print",
}
...
SPANISH_CATEGORY_MAPPINGS = {
    ...
    "(?i).*JABON.*TOCADO(R)?.*": "Personal Care",
