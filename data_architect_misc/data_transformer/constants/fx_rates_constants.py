...
DATE_COLUMN_FX_RATES = 'DATE'
FX_RATES_COLUMN = 'FX_RATES'
YEAR_COLUMN_FX_RATES = 'YEAR'
RAW_COUNTRY_COLUMN = 'COUNTRY'
HARMONIZED_COUNTRY_COLUMN_FX_RATES = 'HARMONIZED_COUNTRY'
CONSTANT_DOLLAR_COLUMN_FX_RATES = 'CONSTANT_DOLLAR_RATIO'
CONSTANT_DOLLAR_COLUMN_SUFFIX = ''.join(['_', CONSTANT_DOLLAR_COLUMN_FX_RATES])
...
ESSENTIAL_COLUMNS_FOR_CONSTANT_USD_DATA = [
    YEAR_COLUMN_FX_RATES,
    HARMONIZED_COUNTRY_COLUMN_FX_RATES,
    CONSTANT_DOLLAR_COLUMN_FX_RATES
]