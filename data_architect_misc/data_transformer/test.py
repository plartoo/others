...
if __name__ == '__main__':
    ...
    print(transform_utils.get_column_names('csv_n.csv', config))
    ...
    print(transform_utils.get_column_names('csv_d.csv', config))
    ...
    print(transform_utils.get_column_names('excel_n.xlsx', config))

    config = {
        'row_index_to_extract_column_names': 4,
        'input_csv_file_delimiter': '|',
    }
    print(transform_utils.get_column_names('excel_d.xlsx', config))
