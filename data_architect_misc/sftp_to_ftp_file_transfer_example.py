...
def main():
    ...
    FTP_TRANSFER_PARAMS = {'from': {'host':'superpa.in', 'username': 'nielsen', 'pwd': 'k7oG27rjrmtpLEjf', 'location': '/files'}, #FAKEPASSWORD
                             'to': {'host':'liveftp.groupm.com', 'username': 'TargetInboundFTP', 'pwd': 'gMnkLm2M', 'location': '/Target Inbound/DataSources/Nielsen'},}
