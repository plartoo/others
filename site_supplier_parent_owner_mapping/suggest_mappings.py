...
#usage: python suggest_mappings.py -i sspo.csv -o results -a 0 -b 3
...
def main(argv):
    ...
    output_table = [[
        ...
        'leven suggested 1', 'score of leven suggested 1', 'leven suggested 1 correct', 'equalOrabove leven threshold 1',
        ...
        'lcs suggested 1', 'score of lcs suggested 1', 'lcs suggested 1 correct', 'equalOrabove lcs threshold 1',
        ...
        'jaccard suggested 1', 'score of jaccard suggested 1', 'jaccard suggested 1 correct', 'equalOrabove jaccard threshold 1',
