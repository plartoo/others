...
Description:
Gmail utils that are created for sending reminder emails to residency programs.
...
def create_message(sender, to, subject, message_text):
    ...
    REF1: https://developers.google.com/gmail/api/v1/reference/users/messages/send
    REF2: https://developers.google.com/gmail/api/guides/sending#creating_messages
    REF3: To create messages with attachment, see below
...
def create_draft(service, user_id, message_body):
    ...
    REF: https://developers.google.com/gmail/api/guides/drafts#creating_draft_messages
